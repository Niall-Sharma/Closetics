...
public class SelectClothesListItem {
    private long id;
    ...
    public SelectClothesListItem(Context context, JSONObject jsonObject, long id, long outfitId, String name, String color, int typeId, int specialTypeId, boolean initiallyChecked) {
    ...
    public boolean isInitiallyChecked() { return initiallyChecked; }
}
